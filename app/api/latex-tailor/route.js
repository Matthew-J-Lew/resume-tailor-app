...
export async function POST(req) {
  try {
    ...
    // Fetch all structured resume data from the database
...
Follow these rules:
- Output the tailored resume as valid LaTeX code, maintaining the same general structure, formatting, and visual style as the original, your output should not include any markdown or additional comments.
