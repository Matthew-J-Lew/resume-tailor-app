...
export async function POST(req) {
    try {
      ...
      // Fetch structured resume data from the database in a single transaction
      ...
      // Combine all fetched data into a single structured object
      ...
      const prompt = `
        ...
        - You may make minor changes to wording or reorganize sections to highlight strengths and align with the job description.
    ...
    // Call the OpenAI API with the prompt and configuration
    ...
    // Return the suggestions as a JSON 
